                ...
                HStack {
                    ...
                    case.none:
                        Text(user.roll.localizedName)                            
                            .bold()
                            .fitButton(color: .gray, vertical: 10, horizontal: 20)
                    case .liar:
                        Text(user.roll.localizedName)
                            .bold()
                            .fitButton(color: Color(red: 0, green: 0.5, blue: 0), vertical: 10, horizontal: 20)
                    case .spy:
                        Text(user.roll.localizedName)
                            .bold()
                            .fitButton(color: .red, vertical: 10, horizontal: 20)
                    }                    
                }
            }            
        }
